...
RUN wget -O /opt/odl/odl.tar.gz https://nexus.opendaylight.org/content/repositories/public/org/opendaylight/integration/karaf/0.7.1/kara
f-0.7.1.tar.gz
...
# Install some prerequisite ODL features, including DLUX (Web UI), NETCONF-over-SSH and the RESTCONF API. Modify 'featuresBoot' setting 
